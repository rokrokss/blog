...
image: "/assets/images/llm/0.png"
description: "개발자로 일한 경험을 돌아보며 LLM·RAG·AI Agent 서비스 사례를 살펴봅니다. 추천, Text-to-SQL, 고객지원과 콘텐츠 모니터링의 구현 방식과 활용 아이디어를 정리합니다."
key: 202504290
picture_frame: shadow
tags:
  - AI
  - LLM
image_alt: "LLM 큐레이터·라벨러·평가자를 활용하는 추천 모델 파이프라인"
---
...
#### 해결방법
![LLM 큐레이터·라벨러·평가자를 활용하는 추천 모델 파이프라인](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/0.png)
...
![평가 대상의 객관성에 따라 LLM 평가 방법을 선택하는 흐름도](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/1.png)
...
![Pinterest Text-to-SQL의 오프라인 벡터 인덱스 생성과 온라인 질의 흐름](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/2.png)
...
![Snowflake Cortex와 VESSL 파이프라인을 활용한 고객지원 에이전트 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/3.png)
...
![문서에서 질문·답변·코드·출처를 포함한 합성 데이터를 만드는 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/4.png)
...
![HyperCLOVA X로 관심사 키워드를 추출하는 프롬프트 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/5.png)
...
![Kafka·임베딩·Pinecone을 연결한 유사 콘텐츠 모니터링 흐름](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/15.png)
...
![자동 생성 프롬프트를 사용하는 제로샷 콘텐츠 분류 파이프라인](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/16.png)
...
![LLM·유사 콘텐츠 탐지 로직별 처리 결과 비교 그래프](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/17.png)
![유사 콘텐츠 로직과 LLM 로직의 정밀도 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/18.png)
![전문 판매자 의심 계정에서 탐지 로직별 재현율 구성](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/19.png)
![고객지원 모델별 요청량과 월간 API 비용 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/20.png)
...
![여러 계층의 근접 이웃 그래프로 구성된 HNSW 인덱스](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/21.png)
...
![당근 동네생활 게시글의 업체 추천 검색 결과 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/22.png)
...
![검색·답변 생성·필터링으로 구성된 RAG 추천 흐름](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/23.png)
![게시글·댓글 임베딩을 저장하고 질의 벡터로 검색하는 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/24.png)
![벡터 검색 결과를 BM25 점수로 재정렬하는 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/25.png)
...
![LLM으로 게시글의 아이템 정보를 추출해 피처 플랫폼에 전달하는 흐름](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/26.png)
...
![노드와 분기로 구성된 당근 고객지원 챗봇 워크플로우](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/llm/27.png)
...
핸즈온으로 `찹찹`이라는 웹을 개발했다. [다음 글](https://kimhyungrok.com/post/2025/05/13/%EA%B0%9C%EB%B0%9C%EC%9E%90-%EC%B1%84%EC%9A%A9%EA%B3%B5%EA%B3%A0-%EC%B6%94%EC%B2%9C-%EC%84%9C%EB%B9%84%EC%8A%A4-%EC%B0%B9%EC%B0%B9-chapchap.html)에서 볼 수 있다.
