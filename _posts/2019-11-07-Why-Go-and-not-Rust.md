...
**Go는 빠르지만, Rust는 더 빠르다.**

**Go는 효율적인 Garbage Collector가 있지만, Rust는 Static Memory Management를 한다.**

**Go는 interface를 가지지만, Rust는 trait이 있고 Zero-cost Abstraction이 가능하다.**
...
기업소프트웨어 개발은 다른 종류의 개발과는 다른, 괴상한 짐승입니다. 만약 경험이 없다면, "기업소프트웨어가 도대체 뭔데?"라고 물으실 수 있습니다.
저는 고문으로 지내면서 그런 종류의 개발 경험이 좀 있습니다. 해당 주제에 관한 제 견해는 다음과 같습니다.

## 기업소프트웨어 개발은 규모에 관한 것이다.
