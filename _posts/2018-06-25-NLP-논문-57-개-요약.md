...
image: "/assets/images/paper-summary/57/1.png"
description: "Marek Rei가 작성한 NLP 논문 57편의 짧은 요약을 한국어로 옮겼습니다. 기계 번역, 단어 표현, 질의응답, 은유와 신경망 모델 등 다양한 연구를 훑어볼 수 있습니다."
key: 201806251
tags:
  - AI
  - NLP
  - 논문
image_alt: "지문과 질문을 입력받아 정답 개체를 찾는 신경망 독해 모델"
---
...
![지문과 질문을 입력받아 정답 개체를 찾는 신경망 독해 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/1.png)
...
![병렬 말뭉치 없이 두 언어의 단어 임베딩 공간을 정렬하는 과정](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/2.png)
...
![단어·문자 attention을 함께 사용하는 문법 오류 교정 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/3.png)
...
![사용자 피드백과 보상 신호로 대화 정책을 학습하는 시스템](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/4.png)
...
![이미지에서 추출한 정보로 개념별 속성을 예측한 결과 표](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/5.png)
...
![미세한 변형을 적용한 적대적 이미지 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/6.png)
...
![문자를 읽을 때 의미·구문 등 언어 정보에 반응하는 뇌 영역](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/7.png)
...
![문장에서 사건과 개체의 관계를 함께 추출한 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/8.png)
...
![번역 후보를 재정렬해 문법 오류를 수정한 문장 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/9.png)
...
![Variational 인코더·추론 모듈·디코더를 결합한 번역 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/10.png)
...
![지식베이스와 수치 정보를 반영하는 언어 생성 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/11.png)
...
![은유적 표현과 문자적 표현의 예시 비교표](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/12.png)
...
![의미 제약 적용 전후 단어 임베딩의 인접 단어 변화](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/13.png)
...
![의료 텍스트 데이터의 레이블별 주석 수와 평균 단어 수](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/14.png)
...
![AlexNet·GoogLeNet·VGGNet의 레이어 수와 파라미터 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/16.png)
...
![훈련 데이터 크기에 따른 텍스트 분류 모델들의 성능 변화](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/17.png)
...
![외부 메모리의 읽기·쓰기와 사용 이력을 관리하는 신경망 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/18.png)
...
![단어 표현에 합성곱과 순환층을 적용하는 문장 처리 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/19.png)
...
![재료 목록과 순차 입력을 이용해 요리 설명을 생성하는 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/20.png)
...
![단어·문장 관계를 트리 형태로 표현한 언어 모델 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/21.png)
...
![이미지의 영역과 문장 표현을 연결한 시각적 관계 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/22.png)
...
![학습 레이블·입력 변형에 따른 신경망 학습과 일반화 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/23.png)
...
![Pixel control·reward prediction 보조 과제를 사용하는 강화학습 에이전트](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/24.png)
...
![언어 임베딩 공간을 개념 속성 공간으로 변환하는 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/25.png)
...
![문장의 단어들을 계층적으로 연결한 두 구문 트리 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/27.png)
...
![언어 분석 과제 사이의 학습 효과를 비교한 히트맵](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/28.png)
...
![학습 말뭉치와 은유·문자적 테스트셋에 따른 성능 개선 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/29.png)
...
![말뭉치별 학습 epoch에 따른 훈련·검증 손실 곡선](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/30.png)
...
![시스템 응답과 사용자 발화로 후보 정보를 판별하는 대화 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/31.png)
...
![개체 표현과 문맥 attention을 결합해 개체 유형을 분류하는 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/32.png)
...
![문장 행렬에 여러 폭의 합성곱과 풀링을 적용하는 분류 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/34.png)
...
![번역 모델과 언어 모델을 결합하는 shallow fusion·deep fusion 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/35.png)
...
![사전학습 양방향 언어 모델을 활용하는 시퀀스 태깅 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/36.png)
...
![Attention을 이용해 문자 단위 입력을 번역하는 인코더·디코더 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/38.png)
...
![질문에 따라 모듈을 조합해 이미지 속 물체를 세는 시각적 질의응답 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/39.png)
...
![인접 구간 예측을 연결해 시퀀스 모델을 학습하는 계산 그래프](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/41.png)
...
![소스·목표 언어의 문장을 공통 잠재 공간으로 연결하는 번역 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/42.png)
...
![문장 내 방해 단어와 거리에 따른 LSTM의 수 일치 예측 성능](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/43.png)
...
![문장 표현을 모아 문서 감성을 분류하는 HierNet·MILNet 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/44.png)
...
![문장 주석 여부를 순차적으로 결정하는 강화학습 기반 active learning](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/45.png)
...
![문자·단어 LSTM으로 품사와 단어 빈도 정보를 예측하는 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/48.png)
...
![이미지를 매개로 두 언어의 에이전트가 소통하고 번역하는 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/49.png)
...
![큰 어휘 집합을 계층으로 나누는 adaptive softmax 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/50.png)
...
![양방향 언어 모델의 단어 예측을 함께 학습하는 시퀀스 태깅 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/51.png)
...
![두 단어의 표현을 게이팅과 유사도 계산으로 결합하는 은유 탐지 모델](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/52.png)
...
![문자 표현과 양방향 문맥으로 문법 오류를 판별하는 신경망 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/53.png)
...
![문법 오류 탐지를 위한 원문과 인위적 오류 문장 비교](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/54.png)
...
![공유 은닉층으로 여러 레이블을 예측하는 공동학습 구조](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/55.png)
...
![문법 정보를 학습한 단어 임베딩과 CNN을 이용한 에세이 점수 예측](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/56.png)
...
![이미지 프롬프트와 문장 응답의 관련성 점수 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/paper-summary/57/57.png)
