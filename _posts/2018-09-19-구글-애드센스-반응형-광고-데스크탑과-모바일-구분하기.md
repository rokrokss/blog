...
image: "/assets/images/responsive-ad/1.png"
description: "블로그의 반응형 애드센스 광고를 화면 너비에 따라 다르게 표시한 구현 기록입니다. 데스크톱·모바일 환경을 구분해 광고 영역을 설정하는 코드를 소개합니다."
key: 201809192
picture_frame: shadow
tags:
  - 블로그
  - AdSense
image_alt: "화면 너비에 따라 광고 영역을 구분하는 애드센스 코드"
---
...
![화면 너비에 따라 광고 영역을 구분하는 애드센스 코드](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/responsive-ad/1.png)
