...
image: "/assets/images/LDA/1.png"
description: "LDA 토픽 모델의 원리를 베타·디리클레 분포부터 설명합니다. 문서·토픽·단어의 관계와 생성 과정, 깁스 샘플링으로 토픽을 추론하는 방법을 정리합니다."
key: 201809260
picture_frame: shadow
tags:
  - AI
  - NLP
image_alt: "문서의 단어들이 여러 토픽의 분포로 연결되는 LDA 예시"
---
...
![문서의 단어들이 여러 토픽의 분포로 연결되는 LDA 예시](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/LDA/1.png){:width="700px"}
...
![문서별 토픽 분포와 토픽별 단어 분포를 나타낸 LDA 확률 그래프](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/LDA/2.png){:width="700px"}
...
![사후확률을 우도와 사전확률의 곱으로 나타낸 베이즈 정리](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/LDA/3.png){:width="210px"}
...
![단어·문서별 토픽 빈도를 이용한 LDA 깁스 샘플링 조건부 확률](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/LDA/4.png){:width="360px"}
