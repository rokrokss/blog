...
image: "/assets/images/social-web-mining/twitter-mining-1-1.png"
description: "Mining the Social Web을 바탕으로 트위터 마이닝의 개념과 API 용어를 정리합니다. 2018년 당시 개발자 앱 생성과 IPython 예제 연결 과정을 기록했습니다."
key: 201801012
modify_date: 2018-05-12
picture_frame: shadow
tags:
  - NLP
image_alt: "Jupyter Notebook에서 트위터 API 인증 정보를 설정하는 예제"
---
...
![트위터 개발자 앱의 이름과 설명을 입력하는 생성 화면](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/social-web-mining/twitter-dev-app.png)
...
![Jupyter Notebook에서 트위터 API 인증 정보를 설정하는 예제](https://raw.githubusercontent.com/rokrokss/blog/master/assets/images/social-web-mining/twitter-mining-1-1.png)
